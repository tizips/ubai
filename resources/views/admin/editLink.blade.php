                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="web_logo" value="{{ old('web_logo') ? old('web_logo') : $link -> web_logo }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <label class="checkbox">
                                        <input type="checkbox" name="show_bottom" data-toggle="checkbox" value="1" @if(empty(old('show_bottom'))) {{ $link->show_bottom ? 'checked' : '' }} @else {{ old('show_bottom') ? 'checked' : '' }}  @endif >
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
